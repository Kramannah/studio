  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: "flex",
        head_cell:
          "text-muted-foreground rounded-md flex-1 font-bold text-[10px] uppercase tracking-wider pb-2",
        ...
        day: cn(
          ...
          "h-10 w-full p-0 font-medium text-sm aria-selected:opacity-100"
        ),
