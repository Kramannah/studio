...
import { Search, PackageCheck, TrendingUp, Info, RefreshCw, Filter } from 'lucide-react';
...
export function Q4AllocationView({ marketingSamples, usedQuantities, loading, onRefresh }: Q4AllocationViewProps) {
                ...
                <CardHeader className="bg-muted/30 border-b pb-6">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        ...
                        <div className="flex items-center gap-2 w-full max-w-md">
                            ...
                            <Button variant="outline" size="icon" className="h-11 w-11 shrink-0" onClick={onRefresh} disabled={loading}>
