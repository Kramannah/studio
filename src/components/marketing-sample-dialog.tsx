      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle className="font-headline flex items-center gap-2">
            ...
            {sample ? "Modify Material" : "Add New Material"}
          </DialogTitle>
          <DialogDescription>
            Update the material details. This quantity will be assigned to all personnel globally.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
